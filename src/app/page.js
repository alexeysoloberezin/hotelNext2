...
export const metadata = {
  title: "Test Iris Hotel Boston - Luxury Rooms, 24/7 Services, Restaurant, Bar & Spa",
      ...
      <div style={{minHeight: '100vh'}}>
        <>
          ...
          <BgImageBlock bg={'/bg1.jpg'} href={'/restaurant'} topImg={'/petalLogo.png'}>
            ...
            <Animation>
              <p className={"max-w-[578px] mt-[20px]"}>Indulge in breakfast or dinner in our elegantly adorned
